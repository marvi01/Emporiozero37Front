                                ...
                                <div id="hightlight-images-preview">
                                    <div className="center-flex">
                                        <div className="btn-group mb-4 d-none d-md-inline-flex" role="group" aria-label="Basic example">
                                            <button className="btn btn-outline-primary active toggle-button btn-sm" type="button" id="toggleDesktop"><i data-toggle="tooltip" data-placement="top" title="Imagens versão desktop" className="fas fa-desktop"></i></button>
                                            <button className="btn btn-outline-primary toggle-button btn-sm" type="button" id="toggleMobile"><i data-toggle="tooltip" data-placement="top" title="Imagens versão mobile" className="fas fa-mobile-alt mx-1"></i></button>
                                        </div>
                                    </div>
                                    <div className="collapse show" id="collapseDesktop">
                                        ...
                                        <div className="mobile-images">
                                            <div className="row justify-content-center">
                                                <div className="col-md-auto">
                                                    <div className="show-preview">
                                                        <img src="imagens/1-mobile.png" className="mobile-image-preview" alt="" />
                                                        <div className="delete-button-container">
                                                ...
                                                <div className="col-md-auto">
                                                    <div className="show-preview">
                                                        <img src="imagens/2-mobile.png" className="mobile-image-preview" alt="" />
                                                        <div className="delete-button-container">
                                                            <button type="button" className="button-delete" data-toggle="modal" data-target="#delete_img_formç.">
                                                                <i className="fas fa-trash"></i>
                                                            </button>
